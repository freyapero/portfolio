...
$site_name_and_path = 'github.com/freyapero/DashDoc.github.io.git/'; //Доменное имя сайта (и путь к каталогу с основным скриптом)
$main_title = 'Сайт на "Маркдаун"'; //Основное заглавие сайта

//Отредактировать переменные по необходимости
